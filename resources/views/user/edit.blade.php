            ...
            <div class="card-body">
                <form action="{{ route('user.update', $user->id) }}" method="POST">
                    ...
                    <div>
                        ...
                        <div class="col-md-6">
                            <input type="password" class="form-control @error('password') is-invalid @enderror" name="new-password"
                    ...
                    <div>
                        ...
                        <div class="col-md-6">
                            <select name="level" id="level" class="form-control">
                                ...
                                <option value="peminjam"<?php if($user->level == 'admin') echo 'selected="selected"'; ?>>Admin</option>
                            </select>
                        </div>
                    </div>
